...
Not everyone browses websites like you do. Semantic HTML helps structure web pages in a way such that people with disabilities (and even those without. Even you!) can still use them. 

While there's a lot of learn in accessibility, the only rule you need to keep in mind for now is
...
Open up VSCode and install the following extension: 
...
2. Each member can then copy this main **branch** and create their own **fork**.

3. If me and you are working on the same fork, it is better to create two copies of it and work on things separately. This is also a branch.
...
![:scale 40%](https://code.visualstudio.com/assets/docs/getstarted/userinterface/sidebyside.png)
...
<p style="font-size: 10px"><i> Gururaja has entered the chat </i></p>
